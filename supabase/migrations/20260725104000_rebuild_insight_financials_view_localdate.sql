-- Rebuild insight_financials_view to align financial reporting windowing with local-day ranges.
...
SELECT
  ...
  ((ci.price * ci.quantity) - (ci.unit_cost * ci.quantity))::numeric AS profit,
