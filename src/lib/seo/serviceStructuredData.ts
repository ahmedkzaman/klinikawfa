...
export function buildServiceStructuredData(input: {
  ...
  const graph: Record<string, unknown>[] = [
    ...
    { '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Utama', item: canonicalUrl('/') }, { '@type': 'ListItem', position: 2, name: 'Perkhidmatan', item: canonicalUrl('/services') }, { '@type': 'ListItem', position: 3, name: input.name, item: url }] },
  ];
