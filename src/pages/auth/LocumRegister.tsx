...
export default function LocumRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = errorMessage.includes('registered')
          ...
          <div className="mx-auto max-w-md">
            <Card className="border-border/70 shadow-card">
              <CardHeader className="space-y-3 text-center">
                ...
                <CardTitle className="font-display text-2xl">Locum Doctor Registration</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                {success ? (
                  <div className="space-y-4 text-center" role="status">
                    ...
                    <Button variant="outline" onClick={() => navigate('/auth')} className="w-full min-h-11">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                      ...
                      <Link to="/auth" className="inline-flex min-h-11 items-center px-2 text-primary hover:underline">
                        Login
                      </Link>
                    </p>
                  </form>
